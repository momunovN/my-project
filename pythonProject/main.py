...
async def btn_1_click(message: types.Message):
    await bot.send_photo(message.chat.id, photo='https://avatars.mds.yandex.net/i?id=fea8d20f2fd808f1899f42f278e6affaf3ee403c-12463617-images-thumbs&n=13', caption='Вот тебе кот', reply_markup=get_keyboard_inline_1())
